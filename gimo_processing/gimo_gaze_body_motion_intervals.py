...
plt.xticks(np.linspace(400,1800,8),['400','600','800','1000','1200', '1400','1600', '1800'],fontsize=20)
plt.yticks(np.arange(0, 0.7, 0.1), fontsize=20)
plt.axis([400, 1800, 0, 0.62])
plt.grid(linestyle = '--', linewidth = 0.8, alpha = 0.5)
plt.legend(fontsize=18, ncol=1)
plt.savefig('gaze_body_motion_gimo.pdf',bbox_inches='tight',dpi=600,pad_inches=0.1)
plt.savefig('gaze_body_motion_gimo.png',bbox_inches='tight',dpi=600,pad_inches=0.1)