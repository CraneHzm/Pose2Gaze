...
plt.savefig('gaze_body_motion_egobody.pdf',bbox_inches='tight',dpi=600,pad_inches=0.1)
plt.savefig('gaze_body_motion_egobody.png',bbox_inches='tight',dpi=600,pad_inches=0.1)