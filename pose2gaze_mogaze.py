...
def main(opt):
    ...
    train_dataset = mogaze_dataset.mogaze_dataset(data_dir, train_subjects, seq_len, actions, joints_used, opt.train_sample_rate)
    ...
    valid_dataset = mogaze_dataset.mogaze_dataset(data_dir, test_subjects, seq_len, actions, joints_used)
...
def eval(opt):
    ...
    test_dataset = mogaze_dataset.mogaze_dataset(data_dir, test_subjects, seq_len, actions, joints_used)
