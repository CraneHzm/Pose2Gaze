from utils import gimo_dataset, seed_torch
...
def main(opt):
    ...
    train_dataset = gimo_dataset.gimo_dataset(data_dir, seq_len, opt.actions, joints_used = joints_used, train_flag = 1, sample_rate = opt.train_sample_rate)
    ...
    valid_dataset = gimo_dataset.gimo_dataset(data_dir, seq_len, opt.actions, joints_used = joints_used, train_flag = 0)
...
def eval(opt):
    ...
    print('>>> loading datasets')        
    test_dataset = gimo_dataset.gimo_dataset(data_dir, seq_len, opt.actions,joints_used = joints_used, train_flag = 0)
